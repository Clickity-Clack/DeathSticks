    ...
    describe('methods', function()
        ...
        describe('getState', function()
            it('should return a corresponding state', function()
                ...
                assert.same(character.body.x, characterState.position.x)
                assert.same(character.body.y, characterState.position.y)
                assert.same(character.body.xSpeed, characterState.position.xSpeed)
                assert.same(character.body.ySpeed, characterState.position.ySpeed)
        ...
        describe('unpackState', function()
            it('should update relevant properties to match the state', function()
                ...
                local characterState = { id = 'hotDang', type = 'derf-a-nerf', position = { x = 12, y = 12, xSpeed = 43, ySpeed = 89}, health = healthState, weapons = weaponState }
