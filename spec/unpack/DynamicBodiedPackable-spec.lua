    ...
    describe('methods', function()
        ...
        describe('getState', function()
            it('should return a corresponding state', function()
                ...
                assert.same(dummyDBPObj.body.x, dynamicBodiedPackableState.position.x)
                assert.same(dummyDBPObj.body.y, dynamicBodiedPackableState.position.y)
                assert.same(dummyDBPObj.body.xSpeed, dynamicBodiedPackableState.position.xSpeed)
                assert.same(dummyDBPObj.body.ySpeed, dynamicBodiedPackableState.position.ySpeed)
        ...
        describe('unpackState', function()
            it('should update relevant properties to match the state', function()
                local dynamicBodiedPackableState = { id = 'hotDang', type = 'derf-a-nerf', position = { x = 12, y = 12, xSpeed = 43, ySpeed = 89} }
