    ...
    describe('methods', function()
        ...
        describe('getState', function()
            it('should return a corresponding state', function()
                ...
                assert.same(dummyProjectileObj.body.x, dynamicBodiedPackableState.position.x)
                assert.same(dummyProjectileObj.body.y, dynamicBodiedPackableState.position.y)
                assert.same(dummyProjectileObj.body.xSpeed, dynamicBodiedPackableState.position.xSpeed)
                assert.same(dummyProjectileObj.body.ySpeed, dynamicBodiedPackableState.position.ySpeed)
                assert.same(dummyProjectileObj.body.angle, dynamicBodiedPackableState.position.angle)
        ...
        describe('unpackState', function()
            it('should update relevant properties to match the state', function()
                local dynamicBodiedPackableState = { id = 'hotDang', type = 'derf-a-nerf', position = { x = 12, y = 12, xSpeed = 43, ySpeed = 89, angle = 0.2} }
        ...
        describe('reId', function()
            local dynamicBodiedPackableState = { id = 'hotDang', type = 'derf-a-nerf', position = { x = 12, y = 12, xSpeed = 43, ySpeed = 89, angle = 0.1} }
